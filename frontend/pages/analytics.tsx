  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="View aggregate analytics and insights for your exam predictions" />
      </Head>

      <AppLayout title="Analytics">
        <div className="animate-fade-in">
          <p style={{ color: "var(--text-muted)", marginBottom: 28, fontSize: "0.9rem" }}>
            Aggregate insights across all your uploaded documents and predictions.
          </p>
          ...
          {loading ? (
            ...
            <div className="glass-card" style={{ padding: "60px 24px", textAlign: "center" }}>
              ...
              <p style={{ fontSize: "1.1rem", fontWeight: 600 }}>No data yet</p>
              ...
              >
                ...
                <div className="glass-card" style={{ padding: 28 }}>
                  ...
                  <div style={{ display: "flex", gap: 32, alignItems: "center" }}>
                    ...
                    <div style={{ textAlign: "center" }}>
                      <div style={{ fontSize: "2.5rem", fontWeight: 900, lineHeight: 1, color: "var(--accent-emerald)" }}>
                        {stats.predictions.max_confidence
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    <div>
                      <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <span style={{ fontSize: "0.85rem", fontWeight: 700 }}>
                          {stats.analyses.avg_processing_time_seconds.toFixed(1)}s
                        </span>
                      </div>
                      <div
                        style={{
                    ...
                    <div>
                      <div style={{ display: "flex", justifyContent: "space-between" }}>
                        ...
                        <span style={{ fontSize: "0.85rem", fontWeight: 700 }}>
                          {stats.predictions.avg_generation_time_seconds.toFixed(1)}s
                        </span>
                      </div>
                      <div
                        style={{
              ...
              >
                ...
                <div>
                  <p style={{ margin: 0, fontSize: "0.85rem", fontWeight: 600 }}>
                    Tip: Upload more documents for better predictions
                  </p>
                  <p style={{ margin: "4px 0 0", fontSize: "0.8rem", color: "var(--text-muted)" }}>
                    The AI learns patterns from historical papers. More data = higher confidence.
                  </p>
                </div>
              </div>
            </>
...
function BigStatCard({
  ...
  return (
    <div className="stat-card">
      ...
      <div style={{ fontSize: "2.25rem", fontWeight: 900, lineHeight: 1.1, color }}>{value}</div>
      <div className="stat-label">{label}</div>
      {sub && (
        <p style={{ color: "var(--text-muted)", fontSize: "0.7rem", marginTop: 6 }}>{sub}</p>
      )}
    </div>
  );
}
