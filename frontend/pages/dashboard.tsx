  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Exyst AI dashboard — view analytics and manage exam predictions" />
      </Head>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {recentDocs.map((doc) => (
                ...
                >
                  ...
                  <span className={`badge badge-${doc.status === "completed" ? "success" : doc.status === "failed" ? "error" : "info"}`}>
                    {doc.status}
                  </span>
                </div>
              ))}
